...
function write_help()
{
    ...
    echo "example:  sanity_check_manger.sh --iotagent sensors.geonovum.nl:8000 --manager sensors.geonovum.nl:8081 -verbose 0"
    echo "other option: you can use environment variables  manager (export HOST_MAN=sensors.geonovum.nl:8081)"
    echo "                                                 iotagent (export HOST_IOT=sensors.geonovum.nl:8000)"
}
...
if test -z "$HOST_MAN" ; then
   export HOST_MAN=sensors.geonovum.nl:8081
fi
